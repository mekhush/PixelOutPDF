...
st.set_page_config(page_title="PixelOutPDF", layout="centered")
st.title("🧠 PixelOutPDF: Remove Specific Images from PDFs")
st.markdown("Upload a PDF, view its images page-wise, select xref images to remove, and download the cleaned file.")

with st.expander("❓ Can't see the image you want to remove? Click here to know why"):
    st.markdown("""
    ...
    🔗 [Remove PDF Restrictions — online2pdf.com](https://online2pdf.com/remove-pdf-restrictions)
